...
export function Blog2DetailsHero() {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <span className="bg-[#D9EAFB] text-[#2C6295] text-[11px] font-bold tracking-wider uppercase px-4 py-1.5 rounded-full">
                Wellness
              </span>
            ...
            <h1 className="font-fraunces font-black text-navy text-[42px] md:text-[56px] leading-[1.05] mb-6">
              Hydration, But Make It <span className="text-[#3679B9]">Delicious</span>
            </h1>

            {/* Excerpt */}
            <p className="text-ink/80 text-[15px] md:text-[16px] leading-[1.7] mb-10 max-w-[480px]">
              Drinks that hydrate and delight. Here's how Tangent keeps it balanced.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-t border-navy/10 pt-8">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#3679B9] text-white flex items-center justify-center font-fraunces font-bold text-[20px]">
                  T
                </div>
                <div>
          ...
          >
            <div className="relative w-full aspect-[4/3] md:aspect-[16/11] rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/blogdetails/can2watermeloncranberry/main.png"
                alt="Hydration, But Make It Delicious"
                fill
