...
export function BlogCard({ imageSrc, category, date, title, excerpt, link, bgColor }: BlogCardProps) {
  return (
    ...
    >
      <Link href={link} className="flex flex-col flex-1 h-full cursor-pointer group/card">
        {/* Image Container */}
        ...
        <div className="p-6 md:p-8 flex flex-col flex-1">
          ...
          <h3 className="font-fraunces font-bold text-navy text-[20px] md:text-[22px] leading-[1.2] mb-3 group-hover/card:text-[#73A642] transition-colors">
            {title}
          </h3>
