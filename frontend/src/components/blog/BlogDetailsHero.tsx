        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <span className="bg-[#EAF1E4] text-[#4A5D3A] text-[11px] font-bold tracking-wider uppercase px-4 py-1.5 rounded-full">
                Ingredients
              </span>
            ...
            <h1 className="font-fraunces font-black text-navy text-[42px] md:text-[56px] leading-[1.05] mb-6">
              Why Watermelon & <span className="text-[#73A642]">Mint</span> Make the Perfect Pair
            </h1>

            {/* Excerpt */}
            <p className="text-ink/80 text-[15px] md:text-[16px] leading-[1.7] mb-10 max-w-[480px]">
              Cool, refreshing, and naturally hydrating — discover how this dynamic duo keeps you fresh all day.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-t border-navy/10 pt-8">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#73A642] text-white flex items-center justify-center font-fraunces font-bold text-[20px]">
                  T
                </div>
                <div>
          ...
          >
            <div className="relative w-full aspect-[4/3] md:aspect-[16/11] rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/blogdetails/can1watermelonmint/main.png"
