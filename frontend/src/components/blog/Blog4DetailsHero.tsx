...
export function Blog4DetailsHero() {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <span className="bg-[#E2F0DD] text-[#4A7235] text-[11px] font-bold tracking-wider uppercase px-4 py-1.5 rounded-full">
                Lifestyle
              </span>
            ...
            <h1 className="font-fraunces font-black text-navy text-[42px] md:text-[56px] leading-[1.05] mb-6">
              Spice Meets Sweet: A <span className="text-[#6A9A4A]">Bold</span> Combo
            </h1>

            {/* Excerpt */}
            <p className="text-ink/80 text-[15px] md:text-[16px] leading-[1.7] mb-10 max-w-[480px]">
              Guava and chilli bring the heat and the sweet. Here's why bold flavors are the new cool.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-t border-navy/10 pt-8">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#6A9A4A] text-white flex items-center justify-center font-fraunces font-bold text-[20px]">
                  T
                </div>
                <div>
          ...
          >
            <div className="relative w-full aspect-[4/3] md:aspect-[16/11] rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/blogdetails/can4guavachilli/main.png"
