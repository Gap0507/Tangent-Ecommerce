  ...
  return (
    <section className="relative w-full min-h-[600px] md:min-h-[650px] overflow-hidden bg-cream">
      <div className="flex flex-col lg:flex-row w-full min-h-[600px] md:min-h-[650px]">
        ...
        <div className="flex-1 flex items-center px-6 md:px-16 lg:px-20 py-8 lg:py-0 relative z-20">
          <motion.div
          ...
          >
            <span className="text-[9px] sm:text-[11px] font-black text-navy/50 uppercase tracking-[0.2em] mb-2 sm:mb-5 block">
              Shop All Flavors
            </span>

            <h1 className="font-fraunces font-black text-navy text-[32px] sm:text-[56px] lg:text-[68px] leading-[0.95] mb-3 sm:mb-6">
              Explore.<br />
            ...
            <p className="text-ink/60 text-[13px] md:text-[17px] leading-[1.5] md:leading-[1.7] mb-4 sm:mb-10 max-w-[440px]">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-10">
              {FLAVORS.map((flavor, idx) => (
                <button
                  ...
                  className={`relative px-3 py-1.5 sm:px-5 sm:py-2.5 rounded-full text-[11px] sm:text-[13px] font-bold transition-all duration-300 cursor-pointer border-2 ${activeIndex === idx
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="bg-navy text-cream px-5 py-3 sm:px-8 sm:py-4 rounded-full font-bold text-[13px] sm:text-[15px] hover:bg-navy/90 transition-all cursor-pointer shadow-xl flex items-center gap-2 sm:gap-2.5 group hover:scale-[1.03]"
              >
        ...
        <div className="w-full lg:w-[55%] relative h-[500px] md:h-auto overflow-hidden">
          <WaterWave
          ...
          >
            {() => (
              <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute z-[1] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full pointer-events-none text-center">
                  <h1
                    ...
                    style={{
                      ...
                      fontSize: isMobile ? "clamp(7rem, 28vw, 14rem)" : "clamp(8rem, 14vw, 20rem)",
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-auto">
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      className="w-[380px] md:w-[480px] lg:w-[540px] h-[560px] md:h-[660px] lg:h-[720px]"
                    >
                      <Can3DViewer
                ...
                <div className="absolute bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-30 bg-white/90 backdrop-blur-xl px-5 sm:px-8 py-2.5 sm:py-3 rounded-2xl shadow-xl border border-white/40 flex items-center gap-4 sm:gap-6 pointer-events-none">
                  <div className="whitespace-nowrap">
                    <p className="text-navy font-black text-[13px] sm:text-[16px] leading-tight">{activeFlavor.name}</p>
                    <p className="text-ink/50 text-[10px] sm:text-[12px]">{activeFlavor.tagline}</p>
                  </div>
                  <div className="h-8 w-px bg-navy/15 shrink-0" />
                  <div className="text-right whitespace-nowrap">
                    <p className="text-navy font-black text-[15px] sm:text-[18px]">{activeFlavor.price}</p>
                    <p className="text-ink/40 text-[9px] sm:text-[11px]">{activeFlavor.packLabel}</p>
                  </div>
                </div>
              </div>
            )}
