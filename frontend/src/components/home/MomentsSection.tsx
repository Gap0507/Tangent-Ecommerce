    ...
    <section className="bg-navy overflow-hidden">
      <div className="flex flex-col lg:flex-row min-h-[420px]">
        ...
        <div className="flex flex-col justify-center px-8 py-14 lg:px-16 lg:py-20 lg:w-[340px] xl:w-[400px] shrink-0">
          <h2 className="font-fraunces font-black text-cream text-[clamp(32px,4vw,52px)] leading-[1.05] mb-4">
            One Can.<br />
            <span className="text-sand">Many Moments.</span>
          </h2>

          {/* Gold underline accent */}
          <div className="w-10 h-[3px] bg-sand rounded-full mb-6" />

          <p className="text-cream/70 text-[15px] leading-[1.6] max-w-[280px] mb-8">
        ...
        {/* ── RIGHT: CARDS ROW ── */}
        <div className="flex-1 flex items-stretch overflow-x-auto scrollbar-none px-4 lg:px-8 pb-8 lg:pb-0 gap-4 lg:gap-5 lg:items-center">
          {moments.map((moment) => (
            <div
              key={moment.id}
              className="relative flex-none w-[220px] md:w-[230px] lg:w-[240px] xl:w-[260px] rounded-2xl overflow-hidden group cursor-pointer border border-white/10 hover:border-white/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_24px_48px_rgba(0,0,0,0.4)]"
