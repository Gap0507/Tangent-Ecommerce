  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          ref={gridRef}
          className="grid grid-cols-1 md:grid-cols-4 auto-rows-[200px] md:auto-rows-[220px] gap-4"
